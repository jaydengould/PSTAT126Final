...
-   price: Price of the diamond in US dollars ranging from \$361 to
    \$18806. This is our target variable for prediction.

**Quantitative Predictor Variables:**

-   carat: Weight of the diamond ranging from 0.2 to 3.0 carats.

-   depth: Measures how deep the diamond is relative to its width
    ranging from 43% to 69.5%.

-   table: Width of the top of the diamond relative to its widest point
    ranging from 52% to 67%.
...
X, Y, Z are slightly right-skewed.
...
**ANOVA Results Summary:** All categorical variables tested (cut,
clarity) show statistically significant relationships with price,
...
1.  Price shows a very strong positive correlation with carat. This
    confirms that the weight of the diamond is a good predictor of
    diamond price.
2.  Both price and carat are highly right-skewed. This suggests that
    log-transformations will likely improve model assumptions.
